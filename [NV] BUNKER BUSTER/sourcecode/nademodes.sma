...
public plugin_init()
{
	...
	register_option(OPTION_MSG_SVC_BAD, "nademodes_svc_bad_error_fix", "1")
...
{
	new iWeapEnt = get_member(id, m_pActiveItem);
	
	if (is_bunkerbuster(iWeapEnt))
		return PLUGIN_CONTINUE
